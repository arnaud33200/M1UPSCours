...
public abstract class ClientComponentType {
  ...
  public interface Requires {
     ...
     * 
     */
    public TypeDeServicePasTerrible unServiceBasiqueBofBof();
  }
  ...
  public interface Provides {
     ...
     * 
     */
    public TypeDeServiceSuperChouette unServiceSuperChouette();
  }
  ...
  public static class ComponentImpl implements ClientComponentType.Component, ClientComponentType.Parts {
    ...
    protected void initProvidedPorts() {
      assert this.unServiceSuperChouette == null: "This is a bug.";
      this.unServiceSuperChouette = this.implementation.make_unServiceSuperChouette();
      if (this.unServiceSuperChouette == null) {
      	throw new RuntimeException("make_unServiceSuperChouette() in CS.ClientComponentType should not return null.");
      }
    ...
    private TypeDeServiceSuperChouette unServiceSuperChouette;
    
    public final TypeDeServiceSuperChouette unServiceSuperChouette() {
      return this.unServiceSuperChouette;
    }
  }
   ...
   * 
   */
  protected abstract TypeDeServiceSuperChouette make_unServiceSuperChouette();
